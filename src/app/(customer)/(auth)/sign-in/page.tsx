...
export default function SignInPage() {
	...
	return (
		<div
    id="signin"
    className="bg-[#FFF8F0] min-h-screen pt-[30px] pb-[50px] flex flex-col"
>
    <div className="container max-w-[1130px] mx-auto flex flex-1 items-center justify-center py-5">
        <form
            action={formAction}
            className="w-[500px] bg-white p-[50px_30px] flex flex-col gap-5 rounded-3xl border border-[#F5E6D8] shadow-sm"
        >
            <h1 className="font-bold text-2xl leading-[34px] text-[#5C2C0C] text-center">
                Welcome Back!
            </h1>
