    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#FFF8F0] to-[#FFE6CC] flex items-center justify-center px-4 py-8">
            <div className="max-w-2xl w-full bg-white rounded-3xl border-2 border-[#FFD699] p-10 text-center shadow-xl transform hover:scale-[1.02] transition-transform duration-300">
                ...
                {/* <div className="bg-gradient-to-r from-[#FFC736] to-[#D27D2D] p-4 rounded-2xl mb-8">
                    <p className="text-white font-semibold text-sm mb-2">GET READY! PROGRAM LAUNCHING SOON</p>
                    <div className="flex justify-center space-x-4">
                        <div className="bg-white/20 p-2 rounded-lg">
                            <span className="text-white font-bold text-xl">30</span>
                            <p className="text-white text-xs">Days</p>
                        </div>
                        <div className="bg-white/20 p-2 rounded-lg">
                ...
                {/* Newsletter Signup */}
                {/* <div className="border-2 border-dashed border-[#FFD699] rounded-2xl p-6 mb-6">
                    <h3 className="font-semibold text-[#5C2C0C] mb-3">Be the first to know!</h3>
                    <div className="flex flex-col sm:flex-row gap-2">
                        <input 
                            type="email" 
                            placeholder="Enter your email" 
                            className="flex-1 px-4 py-3 rounded-full border border-[#F5E6D8] focus:ring-2 focus:ring-[#FFC736] focus:border-transparent"
                        />
                        <button className="px-6 py-3 bg-[#D27D2D] text-white rounded-full font-semibold hover:bg-[#B56A23] transition-colors">
                            Notify Me
                        </button>
                    </div>
                </div> */}
                ...
                {/* Social Media */}
                {/* <div className="flex justify-center space-x-4">
                    <a href="#" className="w-10 h-10 bg-[#FFF3E0] rounded-full flex items-center justify-center hover:bg-[#FFC736] transition-colors">
                        <span className="text-[#5C2C0C]">📱</span>
                    </a>
                    <a href="#" className="w-10 h-10 bg-[#FFF3E0] rounded-full flex items-center justify-center hover:bg-[#FFC736] transition-colors">
                        <span className="text-[#5C2C0C]">💬</span>
                    </a>
