    ...
    >
        {images.map((item, i) => (
            <div key={item + i} className="image-card pr-5 first-of-type:pl-[calc((100vw-1130px-20px)/2)]">
                <div className="bg-white w-[470px] h-[350px] p-10 flex shrink-0 border border-[#F5E6D8] justify-center items-center rounded-[30px] overflow-hidden hover:shadow-md transition-shadow">
                    <img
                        src={item}
